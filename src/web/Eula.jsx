...
export const Eula = () => (
  <div>
    <h2>
      ...
      <span class="app_name">OptimalUI-React</span>
    </h2>
    <p>
      This End-User License Agreement ("EULA") is a legal agreement between you
      and <span class="company_name">OptimalUI</span>.
    </p>

    <p>
      This EULA agreement governs your acquisition and use of our{" "}
      <span class="app_name">OptimalUI-React</span> software ("Software")
      directly from <span class="company_name">OptimalUI</span> or indirectly
      through a <span class="company_name">OptimalUI</span> authorized reseller
    ...
    <p>
      ...
      <span class="app_name">OptimalUI-React</span> software. It provides a
      license to use the <span class="app_name">OptimalUI-React</span> software
      and contains warranty information and liability disclaimers.
    </p>

    <p>
      If you register for a free trial of the{" "}
      <span class="app_name">OptimalUI-React</span> software, this EULA
      agreement will also govern that trial. By clicking "accept" or installing
      and/or using the <span class="app_name">OptimalUI-React</span> software,
    ...
    <p>
      ...
      <span class="company_name">OptimalUI</span> herewith regardless of whether
      other software is referred to or described herein. The terms also apply to
      any <span class="company_name">OptimalUI</span> updates, supplements,
    ...
    <p>
      <span class="company_name">OptimalUI</span> hereby grants you a personal,
      non-transferable, non-exclusive licence to use the{" "}
      <span class="app_name">OptimalUI-React</span> software on your devices in
      accordance with the terms of this EULA agreement.
    </p>

    <p>
      You are permitted to load the{" "}
      <span class="app_name">OptimalUI-React</span> software (for example a PC,
      ...
      <span class="app_name">OptimalUI-React</span> software.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        <span class="company_name">OptimalUI</span> considers is a breach of
        this EULA agreement
      </li>
    </ul>
    ...
    <p>
      <span class="company_name">OptimalUI</span> shall at all times retain
      ...
      remain the property of <span class="company_name">OptimalUI</span>.
    </p>

    <p>
      <span class="company_name">OptimalUI</span> reserves the right to grant
    ...
    <p>
      ...
      written notice to <span class="company_name">OptimalUI</span>.
    </p>
    ...
    <p>
      ...
      the laws of <span class="country">tr</span>.
    </p>
  </div>
);
